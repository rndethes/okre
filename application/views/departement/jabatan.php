          ...
          <?php $role = $this->session->userdata('role_id'); ?>
            ...
            <div class="col-lg-3">
              <button type="button" class="btn btn-dark-primary mb-4 rounded-pill" data-toggle="modal" data-target="#tambahModal">
                ...
                <span class="btn-inner--text">Tambah Jabatan</span>
              </button>
            <?php } ?>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Input Data Jabatan</h5>
                    ...
                    <div class="modal-body">
                      ...
                      <?= form_open_multipart('departement/inputJabatan'); ?>
                      <div class="pl-lg-2">
                        <div class="row">
                          <div class="col-lg-12">
              ...
              <table class="table align-items-center">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort">Nama Jabatan</th>
                    <th scope="col" class="sort">Tingkat Jabatan</th>
                    <th scope="col" class="sort">Nama Departement</th>                
                    <?php if($role == '1') { ?>
                    ...
                    <?php if($role == '1') { ?>
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="<?= base_url(); ?>departement/editJabatan/<?= $jb['id_jabatan']; ?>">Edit</a>
                            <a class="dropdown-item tombol-hapus" data-target="<?= base_url(); ?>departement/deleteJabatan/<?= $jb['id_jabatan']; ?>">Delete</a>
                          </div>
                        </div>
                        </td>
                    <?php } ?>
