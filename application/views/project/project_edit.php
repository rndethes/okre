    ...
    <div class="col-xl-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <?= form_open_multipart('project/editProject/' . $project['id_project']); ?>
          <div class="pl-lg-4">
            <div class="row">
              <div class="col-lg-6">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <?php $iddept = $project['id_departement']; //ambil dari data yg diedit 
                  ?>
                                  ...
                                  <div class="col-4">
                                    <div class="card">
                                      ...
                                      <?php } else { ?>
                                        ...
                                        <div class="my-3">
                                        <label>
                                            <input type="checkbox" name="kuadran[]" value="<?= $okr['id_okr']; ?>">
                                            <?= $okr['description_okr']; ?>
                                        </label>
                                        </div>
                                      <?php } ?>                                      
            ...
            <div class="row">
              ...
              <?php } else { ?>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="hidden" value="<?php echo date('Y-m-d', strtotime($project["tanggal_awal_project"])) ?>" id="tanggal_awal_project" name="tanggal_awal_project">
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group">

                  <input class="form-control" type="hidden" value="<?php echo date('Y-m-d', strtotime($project["tanggal_akhir_project"])) ?>" id="tanggal_akhir_project" name="tanggal_akhir_project">
                </div>
              </div>
              <?php } ?>
            </div>
