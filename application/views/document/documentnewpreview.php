            ...
            <div  id="detailColumn" class="col-lg-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?= base_url('document/documentinputfromokr/space') ?>" class="btn btn-danger mt-4 rounded-pill text-white">
      ...
      document.addEventListener('DOMContentLoaded', function() {
          ...
          loadTemplates().then(function(templates) {
            if (templates.length === 0) {
              ...
              toolbar: 'template | undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | link image media table mergetags |  forecolor  backcolor | align lineheight  |  checklist numlist bullist indent outdent | addcomment showcomments | spellcheckdialog a11ycheck typography | emoticons charmap | removeformat | code | fullscreen preview | save print ',
