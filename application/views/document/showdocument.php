...
<div class="container-fluid mt--6">
  <div class="row">
                ...
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <h3><?= $document['name_document'] ?></h3>
                                ...
                                <div class="text-sm"><b>Nama Dokumen : </b><?= $fildpdf ?></div>
    ...
    let isPDFLoading = false;
        ...
        // Set loading sebelum memuat PDF
        isPDFLoading = true;
        // Swal.fire({
    ...
    // Handle page navigation
        ...
        document.getElementById('simpanSignature').addEventListener('click', async function(e) {
